                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      {trades.map((trade) => {
                        ...
                        // Use the trade's own stored leverage/margin (snapshot at execution time)
                        ...
                        <tr key={trade.id} className="border-b border-border/50 hover:bg-muted/30 transition-colors">
                          ...
                          <td className="py-3 font-mono">{margin !== null ? `$${margin.toFixed(2)}` : '-'}</td>
                          <td className="py-3 font-mono">{positionSize !== null ? `$${positionSize.toFixed(2)}` : '-'}</td>
                          <td className="py-3">
                            <Badge variant={
                              trade.status === 'OPEN' ? 'default' :
                              trade.status === 'CLOSED' ? 'secondary' :
